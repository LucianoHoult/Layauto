...
状态：历史工作流提案，本文不作为当前运行指令。2026-09-08 按用户确认的最小范围编写的 [协作规则](../collaboration/rules.md) 和 [任务模板](../collaboration/task-template.md) 已完成独立 review，未发现实质问题；用户已授权合入 main，审阅身份、验收及下一步见 [当前入口](../current-work.md)。
